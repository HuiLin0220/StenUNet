...
def extract_fingerprint_dataset(dataset_name: str,
    ...
    fpe = fingerprint_extractor_class(dataset_name, num_processes, verbose=verbose)
    return fpe.run(overwrite_existing=clean)


def extract_fingerprints(dataset_name: str, fingerprint_extractor_class_name: str = 'DatasetFingerprintExtractor',
                         num_processes: int = default_num_processes, check_dataset_integrity: bool = False,
                         clean: bool = True, verbose: bool = True):
    """
    ...
    extract_fingerprint_dataset(dataset_name, fingerprint_extractor_class, num_processes, check_dataset_integrity, clean,
                                    verbose)
